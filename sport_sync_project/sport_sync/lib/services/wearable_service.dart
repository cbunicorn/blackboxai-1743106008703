...
class WearableService {
  ...
  // Fetch basic real-time performance data
  Future<PerformanceData> fetchBasicMetrics({
    ...
    return fetchRealtimeData(
      ...
      metrics: [
        ...
        PerformanceData.HEART_RATE,
        PerformanceData.CALORIES,
        PerformanceData.STEPS,
        PerformanceData.ELEVATION,
        PerformanceData.POWER,
        PerformanceData.CADENCE,
      ],
    );
  }

  // Fetch advanced real-time performance data
  Future<PerformanceData> fetchAdvancedMetrics({
    required String userId,
    required String deviceId,
  }) async {
    return fetchRealtimeData(
      ...
      deviceId: deviceId,
      metrics: [
        PerformanceData.VO2_MAX,
        PerformanceData.RECOVERY_TIME,
        PerformanceData.MUSCLE_LOAD,
        PerformanceData.HRV,
        PerformanceData.TEMPERATURE,
        PerformanceData.FATIGUE_INDEX,
        PerformanceData.HYDRATION_LEVEL,
      ],
    );
  }

  // Fetch real-time performance data (base implementation)
  ...
  // Fetch historical basic performance data
  Future<List<PerformanceData>> fetchBasicHistoricalData({
    required String userId,
    required String deviceId,
  ...
  // Fetch historical advanced performance data
  Future<List<PerformanceData>> fetchAdvancedHistoricalData({
    required String userId,
    required String deviceId,
    required DateTime startDate,
    required DateTime endDate,
  ...
  // Fetch historical performance data (base implementation)
